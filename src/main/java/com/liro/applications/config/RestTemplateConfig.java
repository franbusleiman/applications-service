package com.liro.applications.config;
...
public class RestTemplateConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.liro.applications"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Applications API").description("")
