package com.liro.treatments.config;
...
public class RestTemplateConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.liro.treatments"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Treatments API").description("")
